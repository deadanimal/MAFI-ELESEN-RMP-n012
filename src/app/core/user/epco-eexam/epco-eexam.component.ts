...
@Component({
  selector: 'app-epco-eexam',
  templateUrl: './epco-eexam.component.html',
  styleUrls: ['./epco-eexam.component.scss']
})
export class EpcoEexamComponent implements OnInit, AfterViewInit {
